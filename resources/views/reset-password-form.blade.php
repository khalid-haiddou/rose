...
<head>
    ...
    <title>Nouveau mot de passe - Cave & Cellier</title>
    <style>
        :root {
            --navy: #000075;
            --burgundy: #960018;
...
<body>
    <div class="password-container">
        ...
        <p class="instructions">Veuillez entrer votre nouveau mot de passe ci-dessous.</p>
        
        <div class="success-message">
            <p><strong>Mot de passe mis à jour !</strong> Vous pouvez maintenant vous connecter avec votre nouveau mot de passe.</p>
        </div>
        ...
        <form id="passwordForm" method="POST" action="{{ route('password.update') }}">
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" id="new-password" placeholder="••••••••" required>
